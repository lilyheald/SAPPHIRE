...
2.  In Google Sheets, make a copy of the original data, save as "serum_vit_D_study_with_lab_results.xlsx" and manually edit the following:
...
-   delete columns A and B (named ParticipantID and ParticipantCentre, respectively) so that column C becomes your unique identifier (named ParticipantCentreID)
