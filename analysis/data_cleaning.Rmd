...
```{r}
screening_summer <- read_excel(file_path, sheet = "FoodFrequencySummer")
screening_winter <- read_excel(file_path, sheet = "FoodFrequencyWinter")
screening_6weeks <- read_excel(file_path, sheet = "FoodFrequency6Weeks")
```
