...
newlong$Ethnicity <- as.factor(newlong$Ethnicity)
model_ethnicity <- lmer(PC1 ~ VitDResult * Ethnicity + Season + (1 | ParticipantCentreID), data = newlong)

summary(model_ethnicity)

# jitter by ethnicity
ggplot(newlong, aes(x = VitDResult, y = PC1, color = Season)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE) +
  facet_wrap(~ Ethnicity) +
  labs(title = "Relationship between VitDResult and Skin Pigmentation by Ethnicity",
       x = "Vitamin D Level",
       y = "Skin Pigmentation")
