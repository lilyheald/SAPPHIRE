...
# mutlipy by the rotation matrix
  ...
  colnames(pca_scores)[1:2] <- paste0(site_abbr, "_rgb_PC", 1:2)
...
for (name in cie_dataset_list) {
  ...
  colnames(pca_scores)[1:2] <- paste0(site_abbr, "_cie_PC", 1:2)
